...
public class DataItem {
	...
	private static void Insert(Item item){
		...
		try{
			...
			stmt.setString(7, item.getTitulo());

			switch(item.getTipoDisco()){
				case BlueRay: stmt.setInt(8, 1); break;
				case CD: stmt.setInt(8, 2); break;
				case DVD: stmt.setInt(8, 3); break;
				case Pasta: stmt.setInt(8, 4); break;
				case Vinilo: stmt.setInt(8, 5); break;
			}
	...
	private static void Update(Item item){
		...
		try{
			...
			stmt.setString(10, item.getUrlPortada());
			rs = stmt.executeQuery();
